...
import (
	...
	"github.com/uss2022sayahi/kubo/core/coreunix"
...
func (api *UnixfsAPI) Add(ctx context.Context, files files.Node, opts ...options.UnixfsAddOption) (path.Resolved, error) {
	...
	if settings.NoCopy && !(cfg.Experimental.FilestoreEnabled || cfg.Experimental.UrlstoreEnabled) {
		return nil, fmt.Errorf("either the filestore or the urlstore must be enabled to use nocopy, see: https://github.com/uss2022sayahi/kubo/blob/master/docs/experimental-features.md#ipfs-filestore")
	}
