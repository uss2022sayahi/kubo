...
- cut a pre-release on [github](https://github.com/uss2022sayahi/kubo/releases) and upload the result of the ipfs/distributions build in the previous step.
- Announce the RC:
...
- [ ] **Stage 0 - Automated Testing**
  - [ ] Upgrade to the latest patch release of Go that CircleCI has published
    ...
    - [ ] [ipfs/kubo](https://github.com/uss2022sayahi/kubo): [example PR](https://github.com/uss2022sayahi/kubo/pull/8599)
...
- Check the issues with the `help wanted` label in the [ipfs/kubo repo](https://github.com/uss2022sayahi/kubo/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
