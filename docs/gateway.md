...
[config](https://github.com/uss2022sayahi/kubo/blob/master/docs/config.md#gateway)
documentation, including a list of common [gateway recipes](https://github.com/uss2022sayahi/kubo/blob/master/docs/config.md#gateway-recipes).
...
`go-get=1` parameter. See [PR#3964](https://github.com/uss2022sayahi/kubo/pull/3963)
for details</sub>
...
Support for user-provided IPLD selectors is tracked in https://github.com/uss2022sayahi/kubo/issues/8769.
