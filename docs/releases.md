...
This issue is pinned and labeled ["release"](https://github.com/uss2022sayahi/kubo/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+label%3Arelease). When the cycle is due to begin the 5 stages will be followed until the release is done.
