...
[plugin](https://godoc.org/github.com/uss2022sayahi/kubo/plugin) package.
...
|---------------------------------------------------------------------------------|-----------|-----------|------------------------------------------------|
| [git](https://github.com/uss2022sayahi/kubo/tree/master/plugin/plugins/git)           | IPLD      | x         | An IPLD format for git objects.                |
| [badgerds](https://github.com/uss2022sayahi/kubo/tree/master/plugin/plugins/badgerds) | Datastore | x         | A high performance but experimental datastore. |
| [flatfs](https://github.com/uss2022sayahi/kubo/tree/master/plugin/plugins/flatfs)     | Datastore | x         | A stable filesystem-based datastore.           |
| [levelds](https://github.com/uss2022sayahi/kubo/tree/master/plugin/plugins/levelds)   | Datastore | x         | A stable, flexible datastore backend.          |
...
[plugin/plugins](https://github.com/uss2022sayahi/kubo/tree/master/plugin/plugins),
run:
